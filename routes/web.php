...
Route::prefix('admin')->middleware('web')->group(function () {
    ...
    Route::middleware('auth:admin')->group(function () {
        ...
        Route::post('/dashboard/banner', [AdminDashboardController::class, 'uploadBanner'])->name('admin.banner.upload');
        Route::post('/dashboard/promo', [AdminDashboardController::class, 'uploadPromo'])->name('admin.promo.upload');
        Route::post('/dashboard/messages/mark-read', [AdminDashboardController::class, 'markMessagesAsRead'])->name('admin.messages.markRead');
    });
});
